...
- [[Docker and Containerization]] — Packaging software into standardized units.
- [[Kubernetes (K8s) Architecture]] — Automating deployment and management of containerized apps.
- [[ELK Stack (Logging)]] — Distributed logging with Beats, Logstash, Elasticsearch, and Kibana.
- [[Prometheus and Nagios (Monitoring)]] — Systems for infrastructure monitoring and alerting.
- [[Grafana (Visualization)]] — Platform for querying and visualizing metrics.
- [[Jenkins (CI and CD)]] — Open-source automation server for CI/CD pipelines.
- [[Git (Version Control)]] — Distributed version control workflows and operations.

## Linux
- [[Linux Systems (MOC)]] — Map of content for Linux-related system administration.
- [[Linux Architecture (Core)]] — Layered design of the Linux operating system.
- [[Linux Boot Process]] — Stages from hardware power-on to user login.
